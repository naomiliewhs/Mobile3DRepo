            ...
            <div class="row">
                <div class="col-sm-12">
                    <div id="main_3d_image">
                        <div id="main_text" class="col-xs-12 col-sm-12">
                ...
                <div class="row">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="https://www.fanta.com/products" class="btn btn-primary btn-responsive">Find out more ...</a>
                        </div>
                ...
                <div class="row">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div id="subTitle_schweppe" class="card-subtitle drinksText"></div>
                            <div id="description_schweppe" class="card-text drinksText"></div>
                            <a href="https://www.schweppes.eu/classics" class="btn btn-primary btn-responsive">Find out more ...</a>
                        </div>
                    </div>
                </div>
            </div>
